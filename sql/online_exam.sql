...
CREATE TABLE `claacc`  (
  `clasacc_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '这个表用于保存及格率，我并未保存，所以为空',
  `exam_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cla_id` int(0) NULL DEFAULT NULL,
  `tosc_per` int(0) NULL DEFAULT NULL,
  `acsc_per` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `classe`  (
  `classe_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '班级编号',
  `classe_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '班级名',
  `teacher_id` int(0) NULL DEFAULT NULL COMMENT '对应教师',
...
INSERT INTO `classe` VALUES (16, '物联网1班', 7);
...
CREATE TABLE `exam`  (
  `exam_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '考试安排编号',
  `paper_id` int(0) NULL DEFAULT NULL COMMENT '对应试卷',
...
-- Records of exam
-- ----------------------------
INSERT INTO `exam` VALUES (28, 11, '2024-07-07 20:30:00', '2024-07-31 20:30:00');
INSERT INTO `exam` VALUES (29, 13, '2024-07-10 20:30:00', '2024-07-31 20:30:00');
INSERT INTO `exam` VALUES (30, 11, '2024-07-07 20:34:00', '2024-07-28 20:34:00');
...
CREATE TABLE `paper`  (
  `paper_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '试卷编号',
  `paper_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '试卷名字',
  `score_sin` int(0) NULL DEFAULT NULL COMMENT '单选分数',
  `score_che` int(0) NULL DEFAULT NULL COMMENT '多选分数',
  `score_jug` int(0) NULL DEFAULT NULL COMMENT '判断分数',
...
CREATE TABLE `question`  (
  `question_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '题目编号',
...
INSERT INTO `question` VALUES (93, 'x', 'java', '', '', '', '', '', '');
...
CREATE TABLE `question_paper`  (
  ...
  `question_id` int(0) NULL DEFAULT NULL COMMENT '试题编号',
...
CREATE TABLE `record`  (
  ...
  `record_score` int(0) NULL DEFAULT NULL COMMENT '得分',
...
INSERT INTO `record` VALUES (46, 'java综合测试', 15, 11, 'A,A,A,A,A,A,A,F,T,T', 0.40, 38);
...
CREATE TABLE `student`  (
  `student_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '学生编号，默认生成',
  ...
  `student_gender` int(0) NULL DEFAULT NULL COMMENT '性别',
  ...
  `classe_id` int(0) NOT NULL COMMENT '对应班级，外键',
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1, 'aaaaa', '001', 1, 'aaaaa@qq.com', '123456', 1);
INSERT INTO `student` VALUES (2, '刘得滑', '002', 1, 'liudehua@qq.com', '123456', 2);
...
INSERT INTO `student` VALUES (15, 'aaa', '20201111', 1, 'aaa@163.com', '123456', 1);
...
CREATE TABLE `teacher`  (
  `teacher_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '老师编号',
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (1, '赵四', 'admin', 'admin@qq.com', '123456', 1);
INSERT INTO `teacher` VALUES (2, '王五', '20201001', 'mei@163.com', '123456', 0);
INSERT INTO `teacher` VALUES (3, '张二麻子', '20201002', 'xiu@gmail.com', '123456', 0);
INSERT INTO `teacher` VALUES (6, '老六', 'han12', 'han12@qq.com', '123456', 0);
INSERT INTO `teacher` VALUES (7, '老七', 'gu123', 'gu@qq.com', '123456', 0);
...
CREATE TABLE `toscore`  (
  `toscore_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `paper_id` int(0) NULL DEFAULT NULL COMMENT '试卷id',
  `toscore` int(0) NULL DEFAULT NULL COMMENT '总分',
